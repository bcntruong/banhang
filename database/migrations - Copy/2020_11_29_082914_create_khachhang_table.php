...
class CreateKhachhangTable extends Migration
{
    ...
    public function up()
    {
       Schema::create('khachhang', function (Blueprint $table) {
            $table->engine = 'InnoDB';
            $table->unsignedBigInteger('kh_ma',20)->autoIncrement()->comment('Mã khách hàng');
...
//            $table->unsignedTinyInteger('vc_trangThai')->default('2')->comment('Trạng thái # Trạng thái phương thức thanh toán: 1-khóa, 2-hiển thị');
            ...
            $table->timestamp('kh_ngaySinh')->default(DB::raw('CURRENT_TIMESTAMP'))->comment('Ngày sinh # Ngày sinh');
            $table->string('kh_diaChi',250)->default('NULL')->comment('Địa chỉ # Địa chỉ');
